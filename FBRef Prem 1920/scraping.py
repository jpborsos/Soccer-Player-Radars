...
def scrape_data(league):
    ...
    """df_outfield = get_outfield_data('https://fbref.com/en/comps/{}/'.format(num),'/{}-Stats'.format(league))
                df_outfield.to_csv('CSV Data/{}1920_Outfield.csv'.format(abbr), sep=',')

                df_outfield = get_keeper_data('https://fbref.com/en/comps/{}/'.format(num),'/{}-Stats'.format(league))
                df_outfield.to_csv('CSV Data/{}1920_Keeper.csv'.format(abbr), sep=',')

                df_outfield = get_team_data('https://fbref.com/en/comps/{}/'.format(num),'/{}-Stats'.format(league))
                df_outfield.to_csv('CSV Data/{}1920_Squad.csv'.format(abbr), sep=',')"""

    #for i, link in enumerate(['https://fbref.com/en/comps/9/1889/2018-2019-Premier-League-Stats','https://fbref.com/en/comps/9/1631/2017-2018-Premier-League-Stats'])
    link = 'https://fbref.com/en/comps/9/1889/2018-2019-'
    #df_outfield = get_outfield_data('{}'.format(link),'Premier-League-Stats')
    #df_outfield.to_csv('CSV Data/PL1819_Outfield.csv', sep=',')

    #df_outfield = get_keeper_data('{}'.format(link))
    #df_outfield.to_csv('CSV Data/PL1819_Keeper.csv', sep=',')

    df_outfield = get_team_data('{}'.format(link),'Premier-League-Stats')
    df_outfield.to_csv('CSV Data/PL1819_Squad.csv', sep=',')

"""scrape_data('Premier League')
scrape_data('Bundesliga')
scrape_data('Serie A')
scrape_data('Ligue 1')"""
scrape_data('La Liga')
